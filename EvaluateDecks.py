...
def mutate_decks(ranked_records, num_decks, num_swaps=2):
    mutated = []
    ...
    for parent in top_records:
        ...
        # child inherits parent's rating as a starting estimate, rather than
        # resetting to 1200 -- avoids penalizing every mutation before it's even played
